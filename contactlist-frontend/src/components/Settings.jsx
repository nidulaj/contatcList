...
export default function Settings({ darkMode, toggleDarkMode, twoFAEnabled }) {
  ...
  return (
    <div className="absolute top-16 right-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 w-80 z-50">
      <h2 className="text-lg font-semibold mb-4 text-indigo-600 dark:text-indigo-400">Settings</h2>
      <ul className="space-y-3">
        ...
        <li className="flex justify-between items-center px-3 py-2 rounded-md hover:opacity-80 hover:scale-[1.01] transition">
          <span className="text-gray-800 dark:text-gray-100">Two-Factor Authentication</span>
          <button
            onClick={toggle2FA}
